...
import { AlertCircle, CheckCircle2, Copy, ArrowLeft, ExternalLink, Loader } from "lucide-react";
...
export default function WithdrawReview() {
  ...
  const [step, setStep] = useState<"review" | "confirming" | "processing" | "success" | "failure">("review");
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Processing Your Withdrawal</h2>
      ...
      <div className="min-h-screen bg-white">
        ...
        <header className="border-b border-blue-100">
          <div className="max-w-4xl mx-auto px-4 py-4">
            <h1 className="text-2xl font-bold text-gray-900">Withdrawal Confirmation</h1>
          </div>
        </header>
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-2">Withdrawal Submitted Successfully</h2>
          ...
          <div className="bg-gray-50 rounded-xl p-8 border border-gray-200 mb-8">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-start">
                ...
                <span className="font-semibold text-gray-900">{crypto} (Bitcoin)</span>
              </div>
              <div className="border-t border-gray-300 pt-4 flex justify-between items-start">
                <span className="text-gray-600">Amount</span>
                <div className="text-right">
                  <p className="font-semibold text-gray-900">{amount} {crypto}</p>
                  <p className="text-sm text-gray-600">≈ ${(amount * price).toLocaleString()}</p>
                </div>
              </div>
              <div className="border-t border-gray-300 pt-4 flex justify-between items-start">
                <span className="text-gray-600">Network Fee</span>
                <div className="text-right">
                  <p className="font-semibold text-gray-900">{networkFee} {crypto}</p>
                  <p className="text-sm text-gray-600">≈ ${(networkFee * price).toLocaleString()}</p>
                </div>
              </div>
              <div className="border-t border-gray-300 pt-4 flex justify-between items-start">
                <span className="text-gray-600 font-semibold">You'll Receive</span>
                <div className="text-right">
                  <p className="font-bold text-blue-600 text-lg">{receiveAmount} {crypto}</p>
                  <p className="text-sm text-gray-600">≈ ${(receiveAmount * price).toLocaleString()}</p>
                </div>
              </div>
              <div className="border-t border-gray-300 pt-4 flex justify-between items-start">
              ...
              <div className="border-t border-gray-300 pt-4">
                ...
                <div className="flex items-center gap-2">
                  <p className="font-mono text-sm text-gray-900 flex-1 break-all">{txHash}</p>
                  <button
                  ...
                  <a href="#" className="text-blue-600 hover:text-blue-700 flex-shrink-0">
          ...
          <div className="bg-blue-50 rounded-xl p-6 border border-blue-100 mb-8">
            ...
            <ul className="space-y-2">
              <li className="flex gap-2">
                ...
                <span className="text-gray-700">Confirmation email sent to <strong>{email}</strong></span>
              </li>
              <li className="flex gap-2">
                <span className="text-gray-700 font-semibold">1-2 hours</span>
                <span className="text-gray-700">Estimated confirmation time on the blockchain</span>
              </li>
              <li className="flex gap-2">
                <span className="text-gray-700 font-semibold">Always verify</span>
                <span className="text-gray-700">Check the transaction hash on a blockchain explorer</span>
              </li>
            </ul>
          </div>
  ...
  if (step === "failure") {
    return (
      <div className="min-h-screen bg-white">
        <header className="border-b border-blue-100">
          <div className="max-w-4xl mx-auto px-4 py-4">
            <h1 className="text-2xl font-bold text-gray-900">Withdrawal Failed</h1>
          </div>
        </header>
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <div className="text-center mb-8">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-2">Withdrawal Failed</h2>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-blue-100">
        <div className="max-w-4xl mx-auto px-4 py-4">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Review Withdrawal Details</h1>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded mb-8 flex gap-3">
          ...
          <div>
            <p className="font-semibold text-yellow-900 mb-1">⚠️ Please verify all details</p>
            <p className="text-yellow-800 text-sm">
              Crypto transactions cannot be reversed. Ensure the recipient address is correct.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-8 border border-blue-100 shadow-sm mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Withdrawal Summary</h2>

          <div className="space-y-6">
            {/* Cryptocurrency */}
            <div>
              <p className="text-sm text-gray-600 mb-1">Cryptocurrency</p>
              <p className="text-xl font-semibold text-gray-900">{crypto} (Bitcoin)</p>
            </div>

            {/* Amount */}
            <div className="border-t border-gray-200 pt-6">
              <p className="text-sm text-gray-600 mb-1">Withdrawal Amount</p>
              <p className="text-2xl font-bold text-gray-900">{amount} {crypto}</p>
              <p className="text-gray-600 mt-1">≈ ${(amount * price).toLocaleString()}</p>
            </div>

            {/* Network Fee */}
            <div className="border-t border-gray-200 pt-6">
              <p className="text-sm text-gray-600 mb-1">Network Fee</p>
              <p className="text-lg font-semibold text-gray-900">{networkFee} {crypto}</p>
              <p className="text-gray-600 mt-1">≈ ${(networkFee * price).toLocaleString()}</p>
            </div>
            ...
            <div className="border-t border-gray-200 pt-6 bg-blue-50 -mx-8 px-8 py-6 rounded">
              ...
              <p className="text-3xl font-bold text-blue-600">{receiveAmount} {crypto}</p>
            ...
            <div className="border-t border-gray-200 pt-6">
              ...
              <div className="flex items-center gap-2 bg-gray-50 p-3 rounded-lg">
                <p className="font-mono text-sm text-gray-900 flex-1 break-all">{address}</p>
                <button
        ...
        <div className="bg-white rounded-xl p-8 border border-blue-100 shadow-sm mb-8 space-y-4">
          ...
          <div className="flex items-start gap-3 p-4 border border-blue-200 rounded-lg">
            <input
              ...
              onChange={(e) =>
                setConfirmCheckboxes({ ...confirmCheckboxes, verify: e.target.checked })
              }
              className="w-5 h-5 rounded border-gray-300 mt-0.5"
            />
            <label htmlFor="verify" className="text-sm text-gray-700">
              I have verified the recipient address is correct and matches my intended recipient
            </label>
          </div>
          ...
          <div className="flex items-start gap-3 p-4 border border-red-200 rounded-lg">
            <input
              ...
              onChange={(e) =>
                setConfirmCheckboxes({ ...confirmCheckboxes, irreversible: e.target.checked })
              }
              className="w-5 h-5 rounded border-gray-300 mt-0.5"
            />
        ...
        <div className="flex gap-4">
          <button
            ...
            disabled={!confirmCheckboxes.verify || !confirmCheckboxes.irreversible}
